This directory contains my original implementation of a 138M parameter Mixture-of-Experts transformer trained from scratch. It includes custom SentencePiece tokenization, RoPE/SwiGLU/RMSNorm architecture, and top-k MoE routing. Training to 30K steps achieved structured generation but not coherence due to insufficient pretraining data and model scale. This work informed the production architecture decisions. See ../production/ for the deployable model.
